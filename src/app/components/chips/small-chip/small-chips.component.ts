...
@Component({
  selector: 'app-small-chips',
  imports: [TitleCasePipe],
  templateUrl: './small-chips.component.html',
  styleUrl: './small-chips.component.scss',
})
export class SmallChipsComponent implements AfterViewInit {
  chips = input<string[]>();
